...
class KernelBuilder:
    ...
    def build_kernel(
        ...
        if (
            ...
            use_frontier = frontier_k in (2, 3, 4, 5)
            ...
            def emit_group(vec_count, base_offset_const, base_is_zero=False):
                ...
                round_idx = 0
                if use_frontier and frontier_k > 0:
                    depth_to_base = {
                        0: const_0,
                        1: const_1,
                        2: base_idx_2,
                    ...
                    depths = round_depths[:frontier_k]
                    base_idx_consts = [depth_to_base[d] for d in depths]
                    num_buckets_consts = [depth_to_buckets[d] for d in depths]
                    debug_labels = [f"frontier_depth_{d}" for d in depths]
                    emit_bucketed_block(
                        depths,
                        base_idx_consts,
                        num_buckets_consts,
