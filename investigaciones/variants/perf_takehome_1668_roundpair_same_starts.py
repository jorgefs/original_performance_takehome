        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            def emit_group(vec_count, base_offset_const, base_is_zero=False):
                ...
                for round_idx in range(0, rounds, 2):
                    depth0 = round_depths[round_idx]
                    depth1 = round_depths[round_idx + 1]
                    chunk = 1
                    if depth0 > 2:
                        starts = (
                    ...
                    for start in starts:
                        ...
                        emit_hash_only_range(round_idx, depth0, start, count)
                        if depth0 != 0 and depth0 != forest_height:
                        ...
                        emit_hash_only_range(round_idx + 1, depth1, start, count)
                        if depth1 != 0 and depth1 != forest_height:
                            for u in range(start, start + count):
                                body.append(("valu", ("&", v_tmp1[u], v_val[u], v_one)))
                                body.append(
                                    (
