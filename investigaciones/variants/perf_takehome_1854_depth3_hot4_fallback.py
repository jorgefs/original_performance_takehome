...
class KernelBuilder:
    ...
    def build_kernel(
        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            v_level3_hot = [
                self.alloc_scratch(f"v_level3_hot_{i}", length=VLEN) for i in range(4)
            ]
            ...
            def emit_hash_only_range(round_idx: int, depth: int, start: int, count: int):
                ...
                if depth == 0:
                    ...
                    for u in range(count):
                        body.append(("valu", ("-", v_tmp2_l[u], v_idx_l[u], v_forest_values_p)))
                        body.append(("valu", ("-", v_tmp2_l[u], v_tmp2_l[u], v_seven)))
                        body.append(("valu", ("&", v_tmp3_shared, v_tmp2_l[u], v_one)))  # b0
                        body.append(("valu", (">>", v_tmp1_l[u], v_tmp2_l[u], v_one)))
                        body.append(("valu", ("&", v_tmp1_l[u], v_tmp1_l[u], v_one)))  # b1
                        body.append(
                            (
                                "flow",
                                (
                        ...
                        body.append(("valu", ("-", v_tmp1_l[u], v_idx_l[u], v_forest_values_p)))
                        body.append(("valu", ("-", v_tmp1_l[u], v_tmp1_l[u], v_seven)))
                        body.append(("valu", (">>", v_tmp1_l[u], v_tmp1_l[u], v_two)))  # rel>>2
                        for lane in range(VLEN):
                            body.append(
                                ("load", ("load_offset", v_tmp3_shared, v_idx_l[u], lane))
                            )
                        body.append(
                            (
                                "flow",
                        ...
                        body.append(("valu", ("^", v_val_l[u], v_val_l[u], v_tmp2_l[u])))
                    body.extend(
                        self.build_hash_vec_multi(
                            v_val_l,
                            v_tmp1_l,
