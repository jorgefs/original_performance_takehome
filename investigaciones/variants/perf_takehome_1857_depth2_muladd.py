...
class KernelBuilder:
    ...
    def build_kernel(
        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            v_level2_diff01 = self.alloc_scratch("v_level2_diff01", length=VLEN)
            v_level2_diff23 = self.alloc_scratch("v_level2_diff23", length=VLEN)
            self.add("valu", ("-", v_level2_diff01, v_level2[1], v_level2[0]))
            self.add("valu", ("-", v_level2_diff23, v_level2[3], v_level2[2]))
