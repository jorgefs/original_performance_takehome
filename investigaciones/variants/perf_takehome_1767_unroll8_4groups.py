...
class KernelBuilder:
    ...
    def build_kernel(
        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            group_size_const2 = self.scratch_const(VLEN * UNROLL_MAIN * 2)
            group_size_const3 = self.scratch_const(VLEN * UNROLL_MAIN * 3)
            ...
            def emit_group(vec_count, base_offset_const, base_is_zero=False):
                ...
                for round_idx in range(rounds):
                    ...
                    chunk = 1
                    starts = list(range(0, vec_count, 2)) + list(range(1, vec_count, 2))
                    for start in starts:
            ...
            emit_group(UNROLL_MAIN, group_size_const2)
            emit_group(UNROLL_MAIN, group_size_const3)
