        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            def emit_hash_only_range(round_idx: int, depth: int, start: int, count: int):
                ...
                if depth == 0:
                    ...
                    for u in range(count):
                        body.append(("valu", ("+", v_tmp4_l[u], v_idx_l[u], v_base_minus1)))
                        body.append(("valu", ("-", v_tmp4_l[u], v_tmp4_l[u], v_one)))
                        body.append(("valu", ("-", v_tmp4_l[u], v_tmp4_l[u], v_seven)))
                        body.append(("valu", ("&", v_tmp1_l[u], v_tmp4_l[u], v_one)))  # b0
                        body.append(("valu", ("&", v_tmp2_l[u], v_tmp4_l[u], v_two)))  # b1
                        body.append(("valu", ("&", v_tmp3_l[u], v_tmp4_l[u], v_four)))  # b2
                        body.append(
                            (
                                "flow",
                                (
            ...
            def emit_group(vec_count, base_offset_const, base_is_zero=False):
                ...
                for round_idx in range(rounds):
                    ...
                    chunk = 1
                    for start in (0, 2, 4, 6, 8, 10, 12, 14, 1, 3, 5, 7, 9, 11, 13, 15):
