        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            def emit_group(vec_count, base_offset_const):
                ...
                for round_idx in range(rounds):
                    ...
                    if depth != 0 and depth != forest_height and round_idx != rounds - 1:
                        for u in range(vec_count):
                            body.append(("valu", ("&", v_tmp1[u], v_val[u], v_one)))
                            body.append(("valu", ("+", v_tmp2[u], v_tmp1[u], v_base_minus1)))
                            body.append(
                ...
                # Epilogue: last-round index handling (round 15)
                if store_indices:
                    depth = round_depths[-1]
                    if depth == forest_height:
                        for u in range(vec_count):
                            body.append(("valu", ("+", v_idx[u], v_forest_values_p, v_zero)))
                    elif depth == 0:
                        for u in range(vec_count):
                            body.append(("valu", ("&", v_tmp1[u], v_val[u], v_one)))
                            body.append(("valu", ("+", v_idx[u], v_base_plus1, v_tmp1[u])))
