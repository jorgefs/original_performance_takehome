...
class KernelBuilder:
    ...
    def build_kernel(
        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            v_eight = self.vector_const(8, "v_eight")
            ...
            self.add("valu", ("-", v_neg_forest, v_zero, v_forest_values_p))
            ...
            # Debug instructions are disabled in the fast path.

            body = []

            tmp_val_addr = self.alloc_scratch("tmp_val_addr")
            tmp_idx_addr = self.alloc_scratch("tmp_idx_addr") if store_indices else None

            UNROLL_MAIN = 16
            group_size_const = self.scratch_const(VLEN * UNROLL_MAIN)
            ...
            v_tmp3 = [
                self.alloc_scratch(f"v_tmp3_{u}", length=VLEN) for u in range(UNROLL_MAIN)
            ]
            v_tmp4 = [
                self.alloc_scratch(f"v_tmp4_{u}", length=VLEN) for u in range(UNROLL_MAIN)
            ]
            v_tmp5 = [
                self.alloc_scratch(f"v_tmp5_{u}", length=VLEN) for u in range(UNROLL_MAIN)
            ]
            tmp_val_addr_u = [
            ...
            def emit_hash_only(round_idx: int, depth: int, vec_count: int):
                if depth == 0:
                    for u in range(vec_count):
                    ...
                    for u in range(vec_count):
                        body.append(("valu", ("+", v_tmp3[u], v_idx[u], v_base_minus1)))
                        body.append(("valu", ("-", v_tmp3[u], v_tmp3[u], v_four)))
                        body.append(("valu", ("&", v_tmp1[u], v_tmp3[u], v_one)))  # b0
                        body.append(("valu", (">>", v_tmp2[u], v_tmp3[u], v_one)))  # rel3>>1
                        body.append(("valu", ("&", v_tmp2[u], v_tmp2[u], v_one)))  # b1
                        body.append(
                            (
                                "flow",
                                ("vselect", v_tmp3[u], v_tmp1[u], v_level2[3], v_level2[2]),
                            )
                        )
                        body.append(
                            (
                                "flow",
                                ("vselect", v_tmp1[u], v_tmp1[u], v_level2[1], v_level2[0]),
                            )
                        )
                        body.append(
                            ("flow", ("vselect", v_tmp1[u], v_tmp2[u], v_tmp3[u], v_tmp1[u]))
                        )
                        body.append(("valu", ("^", v_val[u], v_val[u], v_tmp1[u])))
                    body.extend(
                        self.build_hash_vec_multi(
                    ...
                    for u in range(vec_count):
                        body.append(("valu", ("+", v_tmp3[u], v_idx[u], v_base_minus1)))
                        body.append(("valu", ("-", v_tmp3[u], v_tmp3[u], v_eight)))  # rel7
                        body.append(("valu", ("&", v_tmp1[u], v_tmp3[u], v_one)))  # b0
                        body.append(("valu", (">>", v_tmp2[u], v_tmp3[u], v_one)))  # rel7>>1
                        body.append(("valu", ("&", v_tmp2[u], v_tmp2[u], v_one)))  # b1

                        body.append(
                            (
                                "flow",
                                ("vselect", v_tmp4[u], v_tmp1[u], v_level3[1], v_level3[0]),
                            )
                        )
                        body.append(
                            (
                                "flow",
                                ("vselect", v_tmp5[u], v_tmp1[u], v_level3[3], v_level3[2]),
                            )
                        )
                        body.append(
                            ("flow", ("vselect", v_tmp4[u], v_tmp2[u], v_tmp5[u], v_tmp4[u]))
                        )  # u0

                        body.append(
                            (
                                "flow",
                                ("vselect", v_tmp5[u], v_tmp1[u], v_level3[5], v_level3[4]),
                            )
                        )
                        body.append(
                            (
                                "flow",
                                ("vselect", v_tmp1[u], v_tmp1[u], v_level3[7], v_level3[6]),
                            )
                        )  # t3 in v_tmp1
                        body.append(
                            ("flow", ("vselect", v_tmp5[u], v_tmp2[u], v_tmp1[u], v_tmp5[u]))
                        )  # u1

                        body.append(("valu", (">>", v_tmp3[u], v_tmp3[u], v_two)))  # rel7>>2
                        body.append(("valu", ("&", v_tmp3[u], v_tmp3[u], v_one)))  # b2
                        body.append(
                            ("flow", ("vselect", v_tmp1[u], v_tmp3[u], v_tmp5[u], v_tmp4[u]))
                        )
                        body.append(("valu", ("^", v_val[u], v_val[u], v_tmp1[u])))
            ...
            def emit_group(vec_count, base_offset_const):
                body.append(
                    ("alu", ("+", tmp_val_addr_u[0], tmp_val_addr, base_offset_const))
                )
                if store_indices:
                    body.append(
                        ("alu", ("+", tmp_idx_addr_u[0], tmp_idx_addr, base_offset_const))
                    )
                for u in range(1, vec_count):
                    ...
                    if store_indices:
                        body.append(
                            (
                                "alu",
                                ("+", tmp_idx_addr_u[u], tmp_idx_addr_u[u - 1], vlen_const),
                            )
                        )
                ...
                for round_idx in range(rounds):
                    ...
                    emit_hash_only(round_idx, depth, vec_count)
            ...
            emit_group(UNROLL_MAIN, zero_const)
            emit_group(UNROLL_MAIN, group_size_const)
