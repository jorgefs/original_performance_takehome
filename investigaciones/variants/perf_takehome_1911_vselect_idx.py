...
class KernelBuilder:
    ...
    def build_kernel(
        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            v_base_minus3 = self.alloc_scratch("v_base_minus3", length=VLEN)
            self.add("valu", ("-", v_base_minus3, v_base_minus1, v_four))
            v_base_minus2 = self.alloc_scratch("v_base_minus2", length=VLEN)
            self.add("valu", ("+", v_base_minus2, v_base_minus1, v_one))
            ...
            def emit_hash_only(round_idx: int, depth: int, vec_count: int):
                if depth == 0:
                    ...
                    for u in range(vec_count):
                        body.append(("valu", ("+", v_tmp3[u], v_idx[u], v_base_minus3)))
