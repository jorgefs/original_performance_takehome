                ...
                if depth == 0:
                    ...
                    if count == 1:
                        for lane in range(VLEN):
                            body.append(
                                ("load", ("load_offset", v_tmp1_l[0], v_idx_l[0], lane))
                            )
                        body.append(("valu", ("^", v_val_l[0], v_val_l[0], v_tmp1_l[0])))
                        body.extend(
                            self.build_hash_vec(
                                v_val_l[0], v_tmp1_l[0], v_tmp2_l[0], round_idx, start * VLEN, emit_debug
                            )
                        )
                    else:
                        body.extend(
