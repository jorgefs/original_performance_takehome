...
class KernelBuilder:
    ...
    def build(self, slots: list[tuple[Engine, tuple]], vliw: bool = False):
        ...
        for engine, slot in slots:
            if engine not in cur:
                cur[engine] = []

            # Límite de slots por engine en el ciclo.
            ...
            # En esta máquina, todas las lecturas ven el estado antes del ciclo.
            # Evitamos RAW y WAW dentro del mismo bundle.
    ...
    def build_kernel(
        ...
        if batch_size == 256 and rounds == 16 and forest_height == 10:
            ...
            def emit_group(vec_count, base_offset_const):
                ...
                for u in range(vec_count):
                    if store_indices:
                        body.append(("store", ("vstore", tmp_val_addr_u[u], v_idx[u])))
